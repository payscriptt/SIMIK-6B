...
<body>
    ...
    <div class="form-group">
        ...
        <input type="text" placeholder="Otomatis" disabled>
    </div>
    ...
    <script>
        ...
        function openPrintPreview() {
            ...
            // 1. Mengambil baris data dari tabel Barang Masuk
            ...
            tableRows.forEach(row => {
                ...
                if(cells.length > 1) {
                    ...
                    rowsHtml += `<tr><td colspan="5" style="padding: 20px; text-align:center; border: 1px solid #dddddd;">Data Barang Masuk Kosong</td></tr>`;
                }
            });

            // 2. Memetakan struktur CSS cetak ke dalam preview area (Tema Hijau/Biru Tua Tua untuk Masuk)
            modalBody.innerHTML = `
                <div style="padding: 30px; font-family: 'Segoe UI', Arial, sans-serif; color: #333333; background: #ffffff;" id="printableArea">
                    <div style="text-align: center; margin-bottom: 30px; border-bottom: 3px double #333333; padding-bottom: 15px;">
                        <h2 style="margin: 0; text-transform: uppercase; font-size: 22px; letter-spacing: 1px;">Laporan Transaksi Barang Masuk</h2>
                    ...
                    <table style="width: 100%; border-collapse: collapse; margin-top: 10px; font-size: 14px;">
                        <thead>
                            <tr style="background-color: #1e3d59; color: #ffffff;">
                                <th style="border: 1px solid #1e3d59; padding: 12px 10px; width: 8%; text-align: center; font-weight: 600;">NO</th>
                                <th style="border: 1px solid #1e3d59; padding: 12px 10px; width: 37%; text-align: left; font-weight: 600;">NAMA BARANG</th>
                                <th style="border: 1px solid #1e3d59; padding: 12px 10px; width: 20%; text-align: center; font-weight: 600;">ID BARANG</th>
                                <th style="border: 1px solid #1e3d59; padding: 12px 10px; width: 20%; text-align: center; font-weight: 600;">TANGGAL IN</th>
                                <th style="border: 1px solid #1e3d59; padding: 12px 10px; width: 15%; text-align: center; font-weight: 600;">JUMLAH</th>
                            </tr>
                        </thead>
                        <tbody>
                            ${rowsHtml}
